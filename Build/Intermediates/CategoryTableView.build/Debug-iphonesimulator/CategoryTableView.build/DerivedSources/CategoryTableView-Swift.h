...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CategoryTableView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17CategoryTableView11AppDelegate")
...
SWIFT_CLASS("_TtC17CategoryTableView15CategoryColCell")
@interface CategoryColCell : UICollectionViewCell
...
SWIFT_CLASS("_TtC17CategoryTableView22CategoryViewController")
...
@interface CategoryViewController (SWIFT_EXTENSION(CategoryTableView)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@interface CategoryViewController (SWIFT_EXTENSION(CategoryTableView)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC17CategoryTableView12MealCellView")
@interface MealCellView : UITableViewCell
...
SWIFT_CLASS("_TtC17CategoryTableView13SceneDelegate")
